 ...
 */
@ContentProvider(authority = MoviesProvider.AUTHORITY, database = MovieDatabase.class, packageName = "com.garzoli.project.popularmoviestage2.privider")
public final class MoviesProvider
{
    public static final String AUTHORITY = "com.garzoli.project.popularmoviestage2.MoviesProvider";
