...
public interface MovieDbAPI {
     ...
     */
    @GET("/movie/{id}/videos")
    public MovieDetailVideoResult getMovieVideo(@Path("id") long id,  @Query("api_key") String key);
    ...
    public MovieDetailReviewResult getMovieReviews(@Path("id") long id,  @Query("api_key") String key);
}